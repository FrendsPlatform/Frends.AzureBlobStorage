    ...
    public class ErrorHandlerTest
    {
        ...
        public void Should_Throw_Error_When_ThrowErrorOnFailure_Is_True()
        {
            var ex = Assert.ThrowsAsync<Exception>(() =>
                AzureBlobStorage.ReadBlob(DefaultInput(), DefaultConnection(), DefaultOptions(), CancellationToken.None));
        ...
        public async Task Should_Return_Failed_Result_When_ThrowErrorOnFailure_Is_False()
        {
            ...
            var result = await AzureBlobStorage.ReadBlob(DefaultInput(), DefaultConnection(), options, CancellationToken.None);
        ...
        public void Should_Use_Custom_ErrorMessageOnFailure()
        {
            ...
            var ex = Assert.ThrowsAsync<Exception>(() =>
                AzureBlobStorage.ReadBlob(DefaultInput(), DefaultConnection(), options, CancellationToken.None));
            Assert.That(ex, Is.Not.Null);
