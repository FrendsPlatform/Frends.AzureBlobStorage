...
public class ErrorHandlerTest
{
    ...
    public async Task Should_Throw_Error_When_ThrowErrorOnFailure_Is_True()
    {
        var exception = await Assert.ThrowsExceptionAsync<Exception>(() =>
            AzureBlobStorage.DeleteContainer(DefaultInput(), DefaultConnection(), DefaultOptions(), CancellationToken.None));
    ...
    public async Task Should_Return_Failed_Result_When_ThrowErrorOnFailure_Is_False()
    {
        ...
        var result = await AzureBlobStorage.DeleteContainer(DefaultInput(), DefaultConnection(), options, CancellationToken.None);
    ...
    public async Task Should_Use_Custom_ErrorMessageOnFailure()
    {
        ...
        var exception = await Assert.ThrowsExceptionAsync<Exception>(() =>
            AzureBlobStorage.DeleteContainer(DefaultInput(), DefaultConnection(), options, CancellationToken.None));
