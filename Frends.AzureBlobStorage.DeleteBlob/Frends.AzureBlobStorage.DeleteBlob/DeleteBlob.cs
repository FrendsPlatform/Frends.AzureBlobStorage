...
public static class AzureBlobStorage
{
    ...
    {
        if (connection.AuthenticationMethod is ConnectionMethod.OAuth2 && (connection.ApplicationId is null ||
        ...
        try
        {
            ...
            var blob = ConnectionHandler.GetBlobClient(container, input.BlobName);
