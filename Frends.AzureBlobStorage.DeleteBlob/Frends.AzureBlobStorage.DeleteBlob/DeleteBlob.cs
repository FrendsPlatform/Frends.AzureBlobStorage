...
public static class AzureBlobStorage
{
    ...
    public static async Task<Result> DeleteBlob([PropertyTab] Input input, [PropertyTab] Options options,
        CancellationToken cancellationToken)
    {
        if (input.ConnectionMethod is ConnectionMethod.OAuth2 && (input.ApplicationID is null ||
        ...
        try
        {
            var blob = ConnectionHandler.GetBlobContainerClient(input, cancellationToken);
