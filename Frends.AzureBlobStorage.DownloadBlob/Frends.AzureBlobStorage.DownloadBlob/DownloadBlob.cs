...
public static class AzureBlobStorage
{
	...
	/// </summary>
	/// <param name="input">Information about which Blob to download.</param>
	/// <param name="connection">Information about the connection to Azure Blob Storage.</param>
	...
	public static async Task<Result> DownloadBlob([PropertyTab] Input input, [PropertyTab] Connection connection, [PropertyTab] Destination destination,
        CancellationToken cancellationToken)
    {
        try
        {
            var blob = ConnectionHandler.GetBlobClient(input, connection, cancellationToken);
            ...
            if (destination.FileExistsOperation == FileExistsAction.Error && File.Exists(fullDestinationPath))
                throw new IOException(
                    "File already exists in destination path. Please delete the existing file or change the \"file exists operation\" to OverWrite.");
