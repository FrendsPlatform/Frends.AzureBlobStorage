...
public static class AzureBlobStorage
{
    ...
    public static async Task<Result> DownloadBlob([PropertyTab] Source source, [PropertyTab] Destination destination,
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            var blob = ConnectionHandler.GetBlobClient(connection, source.ContainerName, source.BlobName,
                cancellationToken);
