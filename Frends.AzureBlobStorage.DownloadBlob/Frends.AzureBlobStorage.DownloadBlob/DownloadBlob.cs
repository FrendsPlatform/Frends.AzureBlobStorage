...
public static class AzureBlobStorage
{
    ...
    public static async Task<Result> DownloadBlob([PropertyTab] Source source, [PropertyTab] Destination destination, [PropertyTab] Connection connection,
        CancellationToken cancellationToken)
    {
        try
        {
            ValidationHandler.Run(source, connection);
            var blob = ConnectionHandler.GetBlobClient(connection, source.ContainerName, source.BlobName, cancellationToken);
