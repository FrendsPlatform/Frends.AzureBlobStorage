...
- Combined `Source` and `Destination` parameters into a single `Input` parameter to align with Frends Task platform standards (breaking change).
- Task class is now static as required by the platform.
